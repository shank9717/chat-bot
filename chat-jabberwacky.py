...
def chat():
    ...
    try:
        ...
        url2 = "https://www.jabberwacky.com/j2reply/"
        ...
        browser.get(url2)
        if "jabber" in browser.current_url:
            pass
        else:
            browser.close()
            chat()
        ...
        while True:
            ...
            if "jabber" in browser.current_url :
                ...
                browser.close()
                chat()
            bot_chat = browser.find_element_by_xpath(
                '/html/body/form/table/tbody/tr/td[1]/table[1]/tbody/tr[10]/td/table/tbody/tr/td[1]/input[1]')
            bot_chat.send_keys(his_reply)
            bot_chat.send_keys(Keys.ENTER)
            while True:
                bot_reply = browser.find_element_by_xpath(
                    r'/html/body/form/table/tbody/tr/td[1]/table[1]/tbody/tr[9]/td/table/tbody/tr/td[1]/span').text
                if bot_reply == his_reply:
                    pass
                elif bot_reply == prev_reply:
                    pass
                else:
                    break
            print(bot_reply)
